        ...
        return(
            <Container fluid style={{paddingLeft: "50px", paddingRight: "50px"}}>
                <div className="input-group mb-4">
                    <input type="text" className="form-control" placeholder="Search an address, transaction or block" value={search_value} onChange={this.onChangeSearch} onKeyPress={this.handleEnterPressed}/>
